...
*	Allows the app to create teams on your behalf by using <b><i>Team.Create</i></b>
...
<table>
  ...
  <tr><td>AzureMailSuffix</td><td>contoso.onmicrosoft.com</td><td>Suffix of the M365 maildomain</td></tr>
...
### Powershell data source '[powershell-datasource]_Teams-create-check-names'

### Powershell data source '[powershell-datasource]_Teams-get-azure-users'

### Delegated form task '[task]_Teams - Create Team'

## Getting help
_If you need help, feel free to ask questions on our [forum](https://forum.helloid.com/forum/helloid-connectors/service-automation/650-helloid-sa-microsoft-teams-create-teams)_
